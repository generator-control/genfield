...
static void loadadc(struct GENFIELDFUNCTION* pcf, double dx, uint8_t idx);
static void loadhv(struct GENFIELDFUNCTION* pcf, uint8_t idx);
static void load4(uint8_t *po, uint32_t n);

/* *************************************************************************
 * void genfield_cmd_msg_i(struct GENFIELDFUNCTION* pcf);
...
/* *************************************************************************
 * static void loadadc(struct GENFIELDFUNCTION* pcf, uint8_t idx);
