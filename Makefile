##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.5.2] date: [Tue Jan 07 21:34:22 EST 2020] 
##########################################################################################################################
...
C_SOURCES += Ourtasks/genfield_cmd_msg.c
C_SOURCES += Ourtasks/GenfieldEvents.c
C_SOURCES += Ourtasks/genfield_func_init.c
C_SOURCES += Ourtasks/genfield_hv.c
C_SOURCES += Ourtasks/genfield_idx_v_struct.c
C_SOURCES += Ourtasks/genfield_msgs.c
C_SOURCES += Ourtasks/GenfieldStates.c
C_SOURCES += Ourtasks/GenfieldTask.c
C_SOURCES += Ourtasks/GenfieldUpdates.c
